...
public class _02_PruebasOneToOne {
	...
	public static void main(String[] args) {
		...
		//persistiendo el objeto Cliente, se persistirám los dos. Si NO hubiera
		// un CASCADE.ALL o un CASCADE.PERSIST, esta persistencia fallará
		em.persist(c); 
		
		// El siguiente "persist" fallará ya que no hay ningun tipo de
		// CASCADE en la clase DatosBancarios
		//em.persist(db); //-> se inserá el cliente SI HUBIERA un cascade en DatosBancarios
