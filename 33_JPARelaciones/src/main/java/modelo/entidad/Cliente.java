...
public class Cliente {
	 ...
	 * De esta manera, tenemos que usar la anotacion @Embedded para decirle a JPA que queremos
	 * poner los atributos de Direccion como campos en la tabla de Cliente
	 * Tambien debemos de anotar la clase Direccion con @Embeddable
	 */
	@Embedded
