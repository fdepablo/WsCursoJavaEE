...
//El objetivo de este ejemplo no es aprender a usar la liber�a, es ver que efectivamente
//gracias a maven, nos descarga autom�ticamente la liber�a y podemos empezar a usarla

//Para m�s informaci�n sobre la librer�a:
//https://zetcode.com/java/pdfbox/

//Si ejecutamos este main podemos ver como se nos crea un documento pdf en la carpeta
//src/main/resources

//Tambien podriamos usar la libreria de conexi�n de MySql sin problema ya que la tenemos
//en las dependencias
	...
	public static void main(String[] args) {
		try (PDDocument doc = new PDDocument()) {
			...
			try (PDPageContentStream cont = new PDPageContentStream(doc, myPage)) {
				...
				String line1 = "Segunda guerra mundial II (often abbreviated to WWII or WW2), "
